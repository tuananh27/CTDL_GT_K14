...
public class SVGDtest {
    ...
    private static void menu()
    {
        ...
        System.out.println("|1Nhập Sinh Viên                                   |");
        System.out.println("|2Xuất Thông Tin                                   |");
        System.out.println("|3Xuất Danh Sách Sinh Viên Theo Điểm               |");
        System.out.println("|4Tìm Sinh Viên Theo Tên                           |");
        System.out.println("|5Tìm Và Xóa Sinh Viên Theo Tên                    |");
        System.out.println("|6Tìm Và Xóa Sinh Viên Theo Điểm                   |");
        System.out.println("|7Thoát                                            |");
        System.out.println("|--------------------------------------------------|");
    }
